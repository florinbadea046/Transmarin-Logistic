  ...
  return (
    <button
      ...
      className={cn(
        ...
        "rtl:translate-x-1/2",
        "rtl:[[data-side=left]_&]:cursor-e-resize rtl:[[data-side=right]_&]:cursor-w-resize",
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute end-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-none transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute end-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-none transition-transform peer-hover/menu-button:text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "after:absolute after:-inset-2 md:after:hidden",
...
function hashToPercent(seed: string) {
  let h = 0;
...
function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(() => `${hashToPercent(id)}%`, [id]);
